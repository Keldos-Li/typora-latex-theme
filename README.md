...
这是一个 Typora 的 markdown 主题样式，在 macOS 上完成开发测试，理论上适用于所有平台，CSS 也适用于部分其他编辑器。macOS 和 Windows 中的个别特性可能不同。**目前Windows显示效果不佳，如有需要可前往develop分支获取最新的代码尝试测试。**
...
*   按照您学校的要求进行个性化设置；[（为什么？怎么改？）](#为什么要个性化修改？)
